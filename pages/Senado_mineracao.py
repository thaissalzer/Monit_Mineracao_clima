...
#inserindo o titulo
st.title('Monitoramento das Proposições Legislativas no Senado')
...
keywords = ["minerais", "mineração", "clima", "ambient", "hidrogênio", "carbono", "data center",  "transição energética"]
